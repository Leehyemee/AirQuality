...
public class AirQualityService {
    ...
    public String getAirQualityDataBasic() throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=%2FApA5lAfnQzZezDlQMqxNFPr%2BtX1e7PM6EEYqOfUg9JSlmszhfwVj9cvXOX31pX0cI6XRtaVkom1j7qQShVMxw%3D%3D"); /*Service Key*/
        ...
        URL url = new URL(urlBuilder.toString());ㅏ
